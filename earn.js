...
// Visible 5-minute countdown UI (server endpoints ready for integration)
let s=300;
setInterval(()=>{const e=document.getElementById('popadsCooldown');if(e&&s>0){s--;const m=String(Math.floor(s/60)).padStart(2,'0');const ss=String(s%60).padStart(2,'0');e.innerHTML='Watch Ads Cooldown: <strong>'+m+':'+ss+'</strong>'; }},1000);
