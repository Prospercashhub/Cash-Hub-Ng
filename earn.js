...
async function completeTask(id) {
  ...
  try {
    ...
    if (result && Number.isFinite(Number(result.reward))) {
      const credited = Number(result.reward).toLocaleString("en-NG", { minimumFractionDigits: 2, maximumFractionDigits: 2 });
      alert("Task completed. ₦" + credited + " has been credited to your wallet.");
    } else {
      alert(result.message || "Task completed successfully and your reward has been credited.");
    }
