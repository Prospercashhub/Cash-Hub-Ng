...
async function shareRef() {
  ...
  try {
    ...
    if (navigator.share) {
      ...
      // Share as text only. Including the URL as a separate `url`
      // field can make some Android share sheets treat the share
      // like a file/document attachment instead of a normal link.
      await navigator.share({
        title: "Join Cash Hub NG",
        text:
          "Join me on Cash Hub NG and start earning.\n\n" +
          url
      });
