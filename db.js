...
async function initializeDatabase() {
  ...
  await pool.query(`
    ...
    -- Preserve the real provider payout separately from the single user-facing
    -- reward transaction. This is an internal accounting field only.
    ALTER TABLE transactions
      ADD COLUMN IF NOT EXISTS provider_amount NUMERIC DEFAULT 0;

    ALTER TABLE transactions
      ADD COLUMN IF NOT EXISTS cashhub_topup NUMERIC DEFAULT 0;
  `);
}
